                            ...
                            <table class="table table-striped m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $d['deskripsi'] }} </td>
                                        <td>{{ isset($d['calon'][0]) ? count($d['calon']) . ' Calon' : '-' }}</td>
                                    </tr>
                                    <?php endforeach ?>
                                </tbody>
                            </table>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group no-margin">
                                        <label for="field-7" class="control-label">Nama Partai</label>
                                        <textarea class="form-control autogrow" name="deskripsi" placeholder="Masukkan nama {{ $title }}"
